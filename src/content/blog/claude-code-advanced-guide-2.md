...
| **DBHub** | PostgreSQL/MySQL/SQLite 범용 접속 | `claude mcp add --transport stdio db -- npx -y @bytebase/dbhub --dsn "postgresql://user:pass@host:5432/db"` |

> DBHub은 DSN 문자열로 PostgreSQL, MySQL, SQLite 모두 연결할 수 있다. 읽기 전용 계정을 사용하는 것을 권장한다.
