...
- <strong>솔루션이 아니라 문제부터</strong> — "소셜 로그인 버튼 추가"는 솔루션이고, "가입을 중도 포기한다"가 문제다. 문제를 건너뛰면 기능만 쌓인다(JTBD: 고객은 '일'을 해결하려 제품을 고용한다).
...
- <strong>스토리 매핑이 디스커버리와 딜리버리를 잇는 다리다</strong> — 가로축은 사용자 여정, 세로축은 릴리스 슬라이스. 첫 슬라이스가 곧 6편의 MVP다.
