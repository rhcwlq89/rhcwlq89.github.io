...
> <strong>참고 — 스크럼의 다섯 가치</strong>: Scrum Guide는 세 기둥을 떠받치는 다섯 가치로 확약(commitment)·집중(focus)·개방(openness)·존중(respect)·용기(courage)를 든다. 특히 <strong>개방</strong>이 투명성의 전제다 — 문제를 솔직히 드러낼 용기가 없으면 투명성은 구호로 끝난다.
...
### 5.1 Definition of Done이 핵심인 이유
...
| 증분(Increment) | 이번 스프린트에 만든, 실제로 쓸 수 있는 결과물(DoD를 만족한 것만) |
