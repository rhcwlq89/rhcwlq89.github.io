...
<strong>"사람이 설정하는 영역(IAM)" 박스</strong>가 우리가 콘솔/Terraform에서 만지는 곳, <strong>"런타임에 자동 동작하는 영역(STS)" 박스</strong>가 우리가 손대지 않아도 요청 시점에 알아서 도는 곳이다. STS는 그 박스 안에 한 줄로 끝난다 — "콘솔에서 안 보인다"고 느낀 직관이 정확했던 셈이다.
